...
/**
 * @brief Retrieve a reference to the decal with the specified name
 *
 * @warning In most cases you should use parseDecalReference to parse a decal reference since the definition alone is
 * not sufficient for creating a decal.
 *
 * @param name The name of the decal to retrieve
 * @return The decal reference of -1 if the decal could not be found
 */
DecalReference getDecalConfig(const SCP_string& name);
